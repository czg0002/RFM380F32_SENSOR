...
/**
 ******************************************************************************
 ** \brief PCA 脉宽调制控制数据类型重定义 (PWM)
 *****************************************************************************/
typedef enum en_pca_pwm
{
    PCAPWMDisable = 0u,            ///< 禁止 PWM功能
    PCAPWMEnable  = 1u,            ///< 允许CCPx引脚作为PWM输出
}en_pca_pwm_t;
