...
uint8_t gTxPayload[PACKET_MAX_LEN] = { 0xAA, 0x55, 22, 0x7f, 7, 0, 0x57, 0xc2, 1, 0, 0, 0};

uint8_t globalWakeupCmd[10] = {0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA9, 0x01, 0x00};
uint8_t singleWakeupCmd[10] = {0xAA, 0x55, 0x16, 0x7f, 0x07, 0x00, 0x57, 0xA1, 0x01, 0x00};
uint8_t broadcastAddr[7] = {0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t sensorAddr[7] = {0xAA, 0x55, 0x16, 0x7f, 0x07, 0x00, 0x57};
uint8_t shortSensorAddr[7] = {0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x57};
/*
 * ===  FUNCTION  ======================================================================
 *         Name:  RF_RxPacket
