...
static uint8_t singleWakeupCmd[10] = {0xAA, 0x55, 0x16, 0x7f, 0x07, 0x00, 0x57, 0xA1, 0x01, 0x00};
static uint8_t broadcastAddr[7] = {0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00};
static uint8_t sensorAddr[7] = {0xAA, 0x55, 0x16, 0x7f, 0x07, 0x00, 0x57};
static uint8_t shortSensorAddr[7] = {0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x57};
/*
 * ===  FUNCTION  ======================================================================
 *         Name:  RF_RxPacket
